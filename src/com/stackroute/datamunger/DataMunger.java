...
public class DataMunger {
	...
	public String[] getSplitStrings(String queryString) {
		...
		String queryString_new = queryString.toLowerCase();
		String arr[] = queryString_new.split(" ");
	...
	public String[] getAggregateFunctions(String queryString) {
		if (!queryString.contains(" * ")) {
			...
			if (queryString.contains(",win")) {
				String queryStringNew = queryString.substring(queryString.indexOf("select ") + 7, queryString.indexOf(",win"));
				String[] queryStringNewOne = queryStringNew.split(",");
				return queryStringNewOne;

			} else if (queryString.contains("sum") || queryString.contains("count") || queryString.contains("min") || queryString.contains("max") || queryString.contains("avg")) {
				String queryStringNew = queryString.substring(queryString.indexOf("select ") + 7, queryString.indexOf(" from"));
				String[] queryStringNewOne = queryStringNew.split(",");
				return queryStringNewOne;
			}
